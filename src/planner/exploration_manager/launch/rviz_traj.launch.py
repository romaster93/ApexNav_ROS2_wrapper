"""
ROS2 Launch file for RViz2 visualization (trajectory mode).
Converted from ROS1 rviz_traj.launch
"""
...
def generate_launch_description():
    ...
    # RViz2 config file (trajectory version)
    rviz_config = os.path.join(
        exploration_manager_share, 'config', 'ApexNav_Traj.rviz'
    )
